...
const statusCommandMetadata = {
	commandName: "status",
	description: "Shows running agentfabric processes",
	usage: "agentfabric status [options]",
	flags: {
		json: "Output raw JSON",
	},
	examples: ["agentfabric status", "agentfabric status --json"],
