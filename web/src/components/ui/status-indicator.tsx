...
const StatusIndicator: React.FC<StatusIndicatorProps> = ({
  ...
  // FIXME: This is for debugging purposes, remove this after confirming the colors and size classes are correct
  console.log("StatusIndicator color:", color, "sizeClasses:", sizeClasses);
